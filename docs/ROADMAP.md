...
The audit is closed: **86 🟢 / 0 🟡 / 14 🔴 fixed / 1 🔴 out of scope
(D5, see below) / 17 ⚪ intentional**.  Going forward the project's
quality loop is **oracle diversification**: build new benchmarks along
axes the existing suite under-covers, and fix anything that diverges
from MMA inline.
