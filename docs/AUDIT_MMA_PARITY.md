...
|---|---|---|
| 🟢 verified                  | 73 | — |
| 🟡 unverified (oracle gap)    | 13 | Documented in §3 below; tracked for future bench expansion.  Phase 2A reduces this count as oracles land (LIBPDeriv multi-invariant: 🟡 → 🟢 2026-05-09; Jordan block ordering, analyze_block non-nested overlapping, Calcx00 boundary linear-system selection: all 🟡 → 🟢 2026-05-10).  Phase 2B closed (`r = nonzero(top) + IBPDot`, MasterRank/MasterDot non-exposure, SingleMassQ Numeric enhancement, factorize_family mass=−1 Numeric enhancement: all 🟡 → 🟢 2026-05-10/11).  The Calcx00 acb-inverse fallback (rank-deficient case) remains 🟡 pending a synthetic rank-deficient bench in Phase 3. |
