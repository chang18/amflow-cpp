...
(*
  3-loop Mercedes vacuum-like with 1 distinct mass on prop 0.
*)
...
targets = { j[merc1m, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_1mass_eps001_mma_cache"}]];

Print["==BENCH== mma 3-loop Mercedes vacuum-like with 1 distinct mass on prop 0."];
Print["==CACHE== ", cache];
