...
(*
  2L crossed-box 4mass at eps=1/1000.
*)
...
targets = { j[xbox4m, 1, 1, 1, 1, 1, 1, 1, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "xbox_2L_4mass_eps001_mma_cache"}]];

Print["==BENCH== mma 2L crossed-box 4mass at eps=1/1000."];
Print["==CACHE== ", cache];
