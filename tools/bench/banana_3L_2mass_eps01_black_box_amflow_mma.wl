...
targets = { j[ban32me01, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "banana_3L_2mass_eps01_mma_cache"}]];

Print["==BENCH== mma 3L banana 2mass at eps=1/100."];
Print["==CACHE== ", cache];
