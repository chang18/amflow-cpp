...
(*
  1L pentagon 4-mass at eps=1/100.
*)
...
targets = { j[p4me1, 1, 1, 1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "pentagon_1L_4mass_eps01_mma_cache"}]];

Print["==BENCH== mma 1L pentagon 4-mass at eps=1/100."];
Print["==CACHE== ", cache];
