...
(*
  1-loop bubble with 2 distinct masses at large mass hierarchy (1 vs 100, s=100).
*)
...
targets = { j[bub2mlrg, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bubble_1L_largemass_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop bubble with 2 distinct masses at large mass hierarchy (1 vs 100, s=100)."];
Print["==CACHE== ", cache];
