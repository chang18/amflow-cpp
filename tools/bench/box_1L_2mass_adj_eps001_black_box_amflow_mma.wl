...
(*
  1-loop box with 2 distinct masses on adjacent props 0 and 1.
*)
...
targets = { j[box2mas, 1, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_2mass_adj_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop box with 2 distinct masses on adjacent props 0 and 1."];
Print["==CACHE== ", cache];
