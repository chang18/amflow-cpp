...
targets = { j[ss3me01, 1, 1, 1, 0, 0] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "sunset_2L_3mass_eps01_mma_cache"}]];

Print["==BENCH== mma 2L sunset 3mass at eps=1/100."];
Print["==CACHE== ", cache];
