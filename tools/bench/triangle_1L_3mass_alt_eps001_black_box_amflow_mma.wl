...
(*
  1-loop triangle with 3 distinct masses (alt: stronger hierarchy + different s).
*)
...
targets = { j[tri3mas, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "triangle_1L_3mass_alt_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop triangle with 3 distinct masses (alt: stronger hierarchy + different s)."];
Print["==CACHE== ", cache];
