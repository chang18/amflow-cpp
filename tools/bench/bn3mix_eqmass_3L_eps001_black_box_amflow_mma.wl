...
(*
  3L bn3mix eqmass on 3 main props (no top).
*)
...
targets = { j[bn3mixeq, 1, 1, 1, 0, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3mix_eqmass_3L_eps001_mma_cache"}]];

Print["==BENCH== mma 3L bn3mix eqmass on 3 main props (no top)."];
Print["==CACHE== ", cache];
