...
targets = { j[merc1p8, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_1mass_psq8_eps001_mma_cache"}]];

Print["==BENCH== mma 3L mercedes 1mass psq=8."];
Print["==CACHE== ", cache];
