...
(*
  1L box 4mass at eps=1/10 (mild eps).
*)
...
targets = { j[box4me10, 1, 1, 1, 1] };
epslist = {1/10};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_4mass_eps10_mma_cache"}]];

Print["==BENCH== mma 1L box 4mass at eps=1/10 (mild eps)."];
Print["==CACHE== ", cache];
