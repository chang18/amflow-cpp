...
targets = { j[bn32p4, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3_2mass_psq4_3L_eps001_mma_cache"}]];

Print["==BENCH== mma 3L bn3 2mass at psq=4."];
Print["==CACHE== ", cache];
