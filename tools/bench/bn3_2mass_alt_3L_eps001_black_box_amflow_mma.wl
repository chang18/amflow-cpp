...
(*
  3L bn3 with mass on l1 and top prop.
*)
...
targets = { j[bn32malt, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3_2mass_alt_3L_eps001_mma_cache"}]];

Print["==BENCH== mma 3L bn3 with mass on l1 and top prop."];
Print["==CACHE== ", cache];
