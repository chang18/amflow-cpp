...
(*
  1-loop box 3-mass at eps=1/100.
*)
...
targets = { j[box3me1, 1, 1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_3mass_eps01_mma_cache"}]];

Print["==BENCH== mma 1-loop box 3-mass at eps=1/100."];
Print["==CACHE== ", cache];
