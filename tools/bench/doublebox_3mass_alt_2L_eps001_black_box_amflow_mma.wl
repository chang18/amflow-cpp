...
(*
  2-loop doublebox 3 masses (alt placement on 0/2/4).
*)
...
targets = { j[dbox3mas, 1, 1, 1, 1, 1, 1, 1, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "doublebox_3mass_alt_2L_eps001_mma_cache"}]];

Print["==BENCH== mma 2-loop doublebox 3 masses (alt placement on 0/2/4)."];
Print["==CACHE== ", cache];
