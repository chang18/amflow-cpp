...
targets = { j[merceqp2, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_eqmass_psq2_eps001_mma_cache"}]];

Print["==BENCH== mma 3L mercedes eqmass psq=2."];
Print["==CACHE== ", cache];
