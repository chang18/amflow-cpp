...
(*
  1-loop box with 2 distinct masses on opposite (non-adjacent) props.
*)
...
targets = { j[box2m, 1, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_2mass_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop box with 2 distinct masses on opposite (non-adjacent) props."];
Print["==CACHE== ", cache];
