...
(*
  3L bn3mix 4mass (3 main + top, but no top prop in index 4).
*)
...
targets = { j[bn3mix4m, 1, 1, 1, 0, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3mix_4mass_3L_eps001_mma_cache"}]];

Print["==BENCH== mma 3L bn3mix 4mass (3 main + top, but no top prop in index 4)."];
Print["==CACHE== ", cache];
