...
(*
  1L box 1mass on 2nd propagator.
*)
...
targets = { j[box1ma, 1, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_1mass_alt_eps001_mma_cache"}]];

Print["==BENCH== mma 1L box 1mass on 2nd propagator."];
Print["==CACHE== ", cache];
