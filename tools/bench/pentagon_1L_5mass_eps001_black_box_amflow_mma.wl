...
(*
  1-loop pentagon with FIVE different internal masses on all five
  propagators.  Most-massive corner of the 1L 5-leg mass axis.
  Target: j[pentagon5m, 1,1,1,1,1] at eps = 1/1000.
*)
...
AMFlowInfo["Numeric"] = {
  s12 -> -2, s23 -> -3, s34 -> -5,
  s13 -> -2, s14 -> 15, s24 -> -3,
  mAsq -> 1, mBsq -> 4, mCsq -> 9, mDsq -> 16, mEsq -> 25
};
AMFlowInfo["NThread"] = 4;

targets = { j[pentagon5m, 1, 1, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "pentagon_1L_5mass_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop pentagon with 5 distinct masses"];
Print["==CACHE== ", cache];
