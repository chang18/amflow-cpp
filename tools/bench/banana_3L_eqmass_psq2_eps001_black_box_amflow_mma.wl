...
targets = { j[ban3eqp2, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "banana_3L_eqmass_psq2_eps001_mma_cache"}]];

Print["==BENCH== mma 3L banana eqmass psq=2."];
Print["==CACHE== ", cache];
