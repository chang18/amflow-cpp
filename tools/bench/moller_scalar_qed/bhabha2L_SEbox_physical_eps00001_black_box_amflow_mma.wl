...
(*
  ...
  Topology: SE-box topology hand-derived from Czakon-Gluza-Riemann hep-ph/0412164 Figure 6 (Box with electron self-energy insertion, B4 prototype). 1L Bhabha box with 1L electron SE bubble inserted on one electron line. 6 main props + 3 ISP for rank 9.
...
AMFlowInfo["Family"] = bhabha2sebox;
...
targets = { j[bhabha2sebox, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/100000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "moller_scalar_qed", "mma_refs",
    "bhabha2L_SEbox_physical_eps00001_mma_cache"}]];

Print["==BENCH== mma bhabha 2L SE-box (1L box + electron self-energy), Euclidean region."];
Print["==CACHE== ", cache];
