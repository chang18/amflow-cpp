...
(*
  ...
  7-propagator parent topology (2 internal massive electron lines) padded with 2 numerator-prop entries (P4, P6) to rank 9.
...
targets = { j[bhabha2pb2m, 1, 1, 1, 0, 1, 0, 1, 1, 1] };
epslist = {1/100000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "moller_scalar_qed", "mma_refs",
    "bhabha2L_PB2m_physical_eps00001_mma_cache"}]];

Print["==BENCH== mma bhabha 2L planar doublebox PB2m (2 internal massive electron lines), Euclidean region."];
Print["==CACHE== ", cache];
