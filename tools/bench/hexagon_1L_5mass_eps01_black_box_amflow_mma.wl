...
targets = { j[h5me1, 1, 1, 1, 1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "hexagon_1L_5mass_eps01_mma_cache"}]];

Print["==BENCH== mma 1L hexagon 5mass at eps=1/100."];
Print["==CACHE== ", cache];
