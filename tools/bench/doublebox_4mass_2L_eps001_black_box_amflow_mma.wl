...
(*
  2-loop doublebox with 4 distinct masses on selected props.
*)
...
targets = { j[doublebox4m, 1, 1, 1, 1, 1, 1, 1, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "doublebox_4mass_2L_eps001_mma_cache"}]];

Print["==BENCH== mma 2-loop doublebox with 4 distinct masses on selected props."];
Print["==CACHE== ", cache];
