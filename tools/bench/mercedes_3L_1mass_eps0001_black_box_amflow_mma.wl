...
(*
  3L mercedes 1mass_eps0001 variant.
*)
...
AMFlowInfo["Family"] = merc1eps0001;
...
targets = { j[merc1eps0001, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/10000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_1mass_eps0001_mma_cache"}]];

Print["==BENCH== mma 3L mercedes 1mass_eps0001 variant."];
Print["==CACHE== ", cache];
