...
(*
  1L triangle 1mass on middle propagator.
*)
...
targets = { j[tri1ma, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "triangle_1L_1mass_alt_eps001_mma_cache"}]];

Print["==BENCH== mma 1L triangle 1mass on middle propagator."];
Print["==CACHE== ", cache];
