...
(*
  1-loop pentagon 3mass at eps=1/100.
*)
...
targets = { j[p3me1, 1, 1, 1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "pentagon_1L_3mass_eps01_mma_cache"}]];

Print["==BENCH== mma 1-loop pentagon 3mass at eps=1/100."];
Print["==CACHE== ", cache];
