...
(*
  3L banana eqmass at eps=1/10000 (high prec).
*)
...
targets = { j[ban3eq0001, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/10000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "banana_3L_eqmass_eps0001_mma_cache"}]];

Print["==BENCH== mma 3L banana eqmass at eps=1/10000 (high prec)."];
Print["==CACHE== ", cache];
