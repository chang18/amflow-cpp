...
targets = { j[bn3mix2malt, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3mix_2mass_alt_3L_eps001_mma_cache"}]];

Print["==BENCH== mma 3L bn3mix 2mass alt (l1, l3)."];
Print["==CACHE== ", cache];
