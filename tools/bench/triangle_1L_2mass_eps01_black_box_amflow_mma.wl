...
(*
  1L triangle 2mass at eps=1/100.
*)
...
targets = { j[tri2me1, 1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "triangle_1L_2mass_eps01_mma_cache"}]];

Print["==BENCH== mma 1L triangle 2mass at eps=1/100."];
Print["==CACHE== ", cache];
