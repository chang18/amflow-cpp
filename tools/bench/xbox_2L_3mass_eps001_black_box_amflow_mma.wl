...
(*
  2-loop crossed box with 3 distinct masses.
*)
...
targets = { j[xbox3m, 1, 1, 1, 1, 1, 1, 1, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "xbox_2L_3mass_eps001_mma_cache"}]];

Print["==BENCH== mma 2-loop crossed box with 3 distinct masses."];
Print["==CACHE== ", cache];
