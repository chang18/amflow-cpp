...
(*
  3L mercedes 2mass alt placement at eps=1/100.
*)
...
targets = { j[merc2maltP, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_2mass_alt_eps01_mma_cache"}]];

Print["==BENCH== mma 3L mercedes 2mass alt placement at eps=1/100."];
Print["==CACHE== ", cache];
