...
(*
  2-loop sunrise with 2 masses on l1 and third prop.
*)
...
targets = { j[sun2mas, 1, 1, 1, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "sunrise_2L_2mass_alt_eps001_mma_cache"}]];

Print["==BENCH== mma 2-loop sunrise with 2 masses on l1 and third prop."];
Print["==CACHE== ", cache];
