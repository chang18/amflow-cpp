...
(*
  3L bn3 with top prop removed (sunrise-like) 3mass.
*)
...
targets = { j[bn3mix3m, 1, 1, 1, 0, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3mix_3mass_3L_eps001_mma_cache"}]];

Print["==BENCH== mma 3L bn3 with top prop removed (sunrise-like) 3mass."];
Print["==CACHE== ", cache];
