...
(*
  1-loop box with 3 masses on props 0/2/3 (alternative placement vs box3m).
*)
...
targets = { j[box3mas, 1, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_3mass_alt_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop box with 3 masses on props 0/2/3 (alternative placement vs box3m)."];
Print["==CACHE== ", cache];
