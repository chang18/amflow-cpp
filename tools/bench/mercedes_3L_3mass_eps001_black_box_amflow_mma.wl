...
(*
  3-loop Mercedes with 3 distinct masses on all three loop propagators.
*)
...
targets = { j[merc3m, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_3mass_eps001_mma_cache"}]];

Print["==BENCH== mma 3-loop Mercedes with 3 distinct masses on all three loop propagators."];
Print["==CACHE== ", cache];
