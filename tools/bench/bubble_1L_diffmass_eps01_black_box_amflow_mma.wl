...
(*
  1L bubble diffmass at eps=1/100.
*)
...
targets = { j[bub2me1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bubble_1L_diffmass_eps01_mma_cache"}]];

Print["==BENCH== mma 1L bubble diffmass at eps=1/100."];
Print["==CACHE== ", cache];
