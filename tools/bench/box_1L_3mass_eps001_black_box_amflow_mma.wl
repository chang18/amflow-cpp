...
(*
  1-loop box with 3 distinct masses on adjacent props 0/1/2.
*)
...
targets = { j[box3m, 1, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_3mass_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop box with 3 distinct masses on adjacent props 0/1/2."];
Print["==CACHE== ", cache];
