...
(*
  2-loop vertex with 2 distinct masses on selected propagators.
*)
...
targets = { j[vtx22m, 1, 1, 1, 1, 1, 1, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "vtx2_2L_2mass_eps001_mma_cache"}]];

Print["==BENCH== mma 2-loop vertex with 2 distinct masses on selected propagators."];
Print["==CACHE== ", cache];
