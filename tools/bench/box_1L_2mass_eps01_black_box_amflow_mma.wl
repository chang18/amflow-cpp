...
(*
  1-loop box 2-mass at eps=1/100 (eps stress).
*)
...
targets = { j[box2me1, 1, 1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_2mass_eps01_mma_cache"}]];

Print["==BENCH== mma 1-loop box 2-mass at eps=1/100 (eps stress)."];
Print["==CACHE== ", cache];
