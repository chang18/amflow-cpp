...
targets = { j[bn34me01, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3_4mass_eps01_3L_mma_cache"}]];

Print["==BENCH== mma 3L bn3 4mass at eps=1/100."];
Print["==CACHE== ", cache];
