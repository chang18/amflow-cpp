...
(*
  3L mercedes 2mass alt (l1, l3 not adjacent).
*)
...
targets = { j[merc2malt, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_2mass_alt_eps001_mma_cache"}]];

Print["==BENCH== mma 3L mercedes 2mass alt (l1, l3 not adjacent)."];
Print["==CACHE== ", cache];
