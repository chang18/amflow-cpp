...
(*
  3-loop banana with 2 distinct masses on 2 of 4 internal lines.
*)
...
targets = { j[bn3mix2m, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "bn3mix_2mass_3L_eps001_mma_cache"}]];

Print["==BENCH== mma 3-loop banana with 2 distinct masses on 2 of 4 internal lines."];
Print["==CACHE== ", cache];
