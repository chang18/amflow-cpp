...
AMFlowInfo["Cut"] = {1, 1, 1, 0, 0};
AMFlowInfo["Numeric"] = {s -> 4};
AMFlowInfo["NThread"] = 4;

targets = {
  j[cutsunrise, 1, 1, 1, 0, 0]
};
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "cutsunrise_2L_eps001_mma_cache"}]];

Print["==BENCH== mma 2-loop massless cutsunrise BlackBoxAMFlow sampled"];
Print["==CACHE== ", cache];
