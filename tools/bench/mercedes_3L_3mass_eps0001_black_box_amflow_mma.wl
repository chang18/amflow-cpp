...
AMFlowInfo["Family"] = merc3eps0001;
...
targets = { j[merc3eps0001, 1, 1, 1, 1, 1, 1, 0, 0, 0] };
epslist = {1/10000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "mercedes_3L_3mass_eps0001_mma_cache"}]];

Print["==BENCH== mma 3L mercedes 3mass eps=1/10000."];
Print["==CACHE== ", cache];
