...
(*
  1-loop pentagon with 3 masses on different prop placement (0,1,3).
*)
...
targets = { j[pent3mas, 1, 1, 1, 1, 1] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "pentagon_1L_3mass_alt_eps001_mma_cache"}]];

Print["==BENCH== mma 1-loop pentagon with 3 masses on different prop placement (0,1,3)."];
Print["==CACHE== ", cache];
