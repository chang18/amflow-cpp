...
targets = { j[ban32p2, 1, 1, 1, 1, 0, 0, 0, 0, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "banana_3L_2mass_psq2_eps001_mma_cache"}]];

Print["==BENCH== mma 3L banana 2mass psq=2."];
Print["==CACHE== ", cache];
