...
(*
  2-loop vertex with 1 distinct mass on prop 0.
*)
...
targets = { j[vtx21m, 1, 1, 1, 1, 1, 1, 0] };
epslist = {1/1000};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "vtx2_2L_1mass_eps001_mma_cache"}]];

Print["==BENCH== mma 2-loop vertex with 1 distinct mass on prop 0."];
Print["==CACHE== ", cache];
