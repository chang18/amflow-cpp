...
(*
  2L sunset with 4 effective masses (3 props + l1+p mass via index).
*)
...
targets = { j[ss4me01, 1, 1, 1, 1, 0] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "sunset_2L_4mass_eps01_mma_cache"}]];

Print["==BENCH== mma 2L sunset with 4 effective masses (3 props + l1+p mass via index)."];
Print["==CACHE== ", cache];
