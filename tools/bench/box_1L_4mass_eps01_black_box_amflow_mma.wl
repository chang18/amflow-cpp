...
(*
  1-loop box 4-mass at eps=1/100 (eps variation of box_1L_4mass).
*)
...
targets = { j[box4me1, 1, 1, 1, 1] };
epslist = {1/100};
cache = Environment["AMF_BENCH_MMA_CACHE"];
If[cache === $Failed || cache === None,
  cache = FileNameJoin[{repo, "tools", "bench", "mma_refs",
    "box_1L_4mass_eps01_mma_cache"}]];

Print["==BENCH== mma 1-loop box 4-mass at eps=1/100 (eps variation of box_1L_4mass)."];
Print["==CACHE== ", cache];
